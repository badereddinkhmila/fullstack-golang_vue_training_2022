<template>
  <el-aside class="shadow-lg bg-white">
    <h3 class="font-bold p-2">Marketplace</h3>
    <el-divider />
    <el-scrollbar>
      <el-menu>
        <el-sub-menu index="1">
          ...
          <el-menu-item-group>
            ...
            <el-divider />
            <router-link :to="{ name: 'list_products' }">
        ...
        <el-sub-menu index="2">
          ...
          <el-menu-item-group>
            ...
            <el-divider />
            <router-link :to="{ name: 'list_categories' }">
        ...
        <el-divider />
        <h4 class="font-bold p-2">Validation</h4>
        <el-sub-menu index="4">
          <template #title>
            <el-icon><ShoppingCart /></el-icon>Validation
          </template>
          <el-menu-item-group>
            <template #title>Group 1</template>
            <el-menu-item index="3-1"
